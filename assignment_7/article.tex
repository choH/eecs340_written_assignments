...
\subsection{Shaochen (Henry) ZHONG's proof of course evalution}
...
\subsection{Yuhui ZHANG's proof of course evalution}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{{fig/fig_4_b.png}}
\end{figure}
